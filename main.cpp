...
double elapsed_seconds(const std::chrono::steady_clock::time_point& start_time, const std::chrono::steady_clock::time_point& end_time, int decimal_places) {
    ...
    double decimal_scale = std::pow(10.0, decimal_places);
    return std::ceil(elapsed_millis / 1000.0 * decimal_scale) / decimal_scale;
}
...
int main(int, char**){
    ...
    std::cout << "Total Time: " << elapsed_seconds(start_time, end_time, 3) << "s\n";
}
